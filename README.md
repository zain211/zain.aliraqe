...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf zain.aliraqe && rm -rf .telegram-cli && git clone https://github.com/zain211/zain.aliraqe.git && cd zain.aliraqe && ./launch.sh install && ./launch.sh
~~~~~
